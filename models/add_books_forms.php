<div class="form-perso">
    ...
    <form action="./employerDashboard.php?addBook=1" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group pt-2" >
                        ...
                        <textarea name="descriptions" class="form-control" id="contactForm1" cols="20" rows="3" placeholder="Description de l'ouvrage"  required><?php if(!empty($return) && $return === false) {echo addslashes($_POST['descriptions']);} ?></textarea>
                    </div>
                    <div class="form-group pt-2">
                        <label for="contactForm1">Date de publication</label> 
                        <input type="date" class="form-control" id="contactForm1" name="publication_date" <?php if(!empty($return) && $return === false) {echo 'value="'.$_POST['publication_date'].'"';} ?>>
                    </div>   
                    <div class="form-group pt-2" >
                        <label for="contactForm1">Auteur *</label>
                        <input type="text" class="form-control" id="contactForm1" name="auteur" placeholder="Nom de l'auteur" <?php if(!empty($return) && $return === false) {echo 'value="'.$_POST['auteur'].'"';} ?> required>
                    </div>
                    <div class="form-group pt-2" >
                        <label for="contactForm1">Genre *</label>
                        <input type="text" class="form-control" id="contactForm1" name="genre" placeholder="Roman" <?php if(!empty($return) && $return === false) {echo 'value="'.$_POST['genre'].'"';} ?> required>
                    </div>
                    <div class="form-group pt-2">
